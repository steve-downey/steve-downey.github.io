...
<p> The outer <code>Makefile</code> is responsible for checking if Docker has been requested and for making sure the container is ready. The makefile has a handful of targets of its own, but otherwise defers everything to <code>targets.mk</code>. </p>
