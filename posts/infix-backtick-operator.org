...
use case, and I would like to hear about it. The design log, the per-compiler
implementation plans, and the running record of where reality corrected the
design all live alongside this post; comments, objections, and motivating
examples are all welcome before this goes in front of the committee.
